...
export const content = {
  details: {
    id: 1,
    heading: 'Try Scuba Dive + Dhow Cruise Ticket',
    price: 450,
    promoPrice: 350,
    from: 'try-dive',
  },
  banner: {
    image: {
      src: getAssetsUrl('/images/pages/dsd/dhow/banner.png'),
      alt: 'Try Dive + Dhow Cruise Ticket Banner - Bermuda',
    },
    heading: 'Try Dive + Dhow Cruise Ticket',
    breadcrumb: {
      lv1T: 'Try Dives / ',
      lv1L: '#',
      lv2T: 'Dhow Cruise Ticket',
      lv2L: '#',
    },
    description:
      "Experience the Best of Dubai's Underwater World with Bermuda Diving Center's 'Try Scuba Diving' Package + Complimentary Intercontinental Buffet Dinner on a Dhow Cruise",
    button: {
      href: '/reservation',
      text: 'Book Now',
      trackingId: 'lp-dhow-bn',
    },
  },
  how: {
    heading: 'Try Scuba Diving + Dhow Cruise Ticket',
    description: [
      <p key={1}>
    ...
    data: [
      {
        image_url: getAssetsUrl(
          '/images/pages/dsd/thumbnails/yacht-cruise.png'
        ),
        title: 'Try Scuba',
