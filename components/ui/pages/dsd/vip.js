...
export const content = {
  details: {
    id: 5,
    heading: 'Try Scuba Diving - VIP',
    price: 550,
    from: 'try-dive',
  },
  banner: {
    image: {
      src: getAssetsUrl('/images/pages/dsd/vip/banner.png'),
      alt: 'Try Scuba Diving - VIP Banner - Bermuda',
    },
    heading: 'Try Scuba Diving - VIP (1 On 1)',
    breadcrumb: {
      lv1T: 'Try Dives / ',
      lv1L: '#',
      lv2T: 'VIP',
    ...
    description:
      "Experience the Ultimate in Scuba Diving Luxury with Bermuda Diving Center's 'Try Scuba Diving - VIP' Package with Private Instructor and Briefing.",
    button: {
      href: '/reservation',
      text: 'Book Now',
    },
