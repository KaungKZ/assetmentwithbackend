...
export const content = {
  details: {
    id: 3,
    heading: 'Try Dive + Yacht Cruise Ticket',
    price: 350,
    from: 'try-dive',
  },
  banner: {
    image: {
      src: getAssetsUrl('/images/pages/dsd/yacht/banner.png'),
      alt: 'Try Dive + Yacht Cruise Ticket Banner - Bermuda',
    },
    heading: 'Try Dive + Yacht Cruise Ticket',
    breadcrumb: {
      lv1T: 'Try Dives / ',
      lv1L: '#',
      lv2T: 'Yacht Cruise Ticket',
      lv2L: '#',
    },
    description:
      "Experience the Best of Dubai's Underwater World with Bermuda Diving Center's 'Try Scuba Diving' Package + Complimentary Luxury Yacht Cruise Ticket!",
    button: {
      href: '/reservation',
      text: 'Book Now',
    },
  ...
  how: {
    heading: 'Try Scuba Diving + Yacht Cruise Ticket',
    description: [
      <p key={1}>
  ...
  about: {
    ...
    // sideImage: {
    //   src: '/images/pages/dsd/package-comparison.png',
    //   alt: 'Try Scuba Diving - Package Comparison',
    // },
  },
  featured: {
