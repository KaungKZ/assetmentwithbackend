...
export const content = {
  details: {
    id: 4,
    heading: 'Try Scuba Diving - Luxury',
    price: 450,
    from: 'try-dive',
  },
  banner: {
    image: {
      src: getAssetsUrl('/images/pages/dsd/luxury/banner.png'),
      alt: 'Try Scuba Diving - Luxury Banner - Bermuda',
    },
    heading: 'Try Scuba Diving - Luxury',
    breadcrumb: {
      lv1T: 'Try Dives / ',
  ...
  how: {
    ...
    steps: {
      ...
      three: {
        imageSrc: getAssetsUrl('/images/pages/dsd/steps/luxury/3.png'),
