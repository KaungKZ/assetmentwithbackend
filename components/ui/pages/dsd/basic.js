...
export const content = {
  details: {
    id: 36,
    heading: 'Basic Try Dive',
    price: 400,
    from: 'try-dive',
  },
  banner: {
    image: {
      src: getAssetsUrl('/images/pages/dsd/basic/banner.png'),
      alt: 'Basic Try Dive Banner - Bermuda',
    },
    heading: 'Basic Try Dive',
    breadcrumb: {
      lv1T: 'Try Dives / ',
    ...
    description:
      "Discover Dubai's captivating underwater realm with Bermuda Diving Center's 'Try Scuba Diving' package.",
    button: {
      href: '/reservation',
      text: 'Book Now',
    },
  ...
  about: {
    ...
    // video: {
    //   poster: `${process.env.NEXT_PUBLIC_AWS_ASSETS_URL}/images/pages/dsd/aquafun/poster.jpg`,
    //   src: `${process.env.NEXT_PUBLIC_AWS_ASSETS_URL}/videos/dsd/aquafun-promo.mp4`,
    // },
    // sideImage: {
