...
export const content = {
  details: {
    id: 2,
    heading: 'Try Dive + Drift Trike Ticket',
    price: 299,
    from: 'try-dive',
  },
  banner: {
    image: {
      src: getAssetsUrl('/images/pages/dsd/drift-trike/banner.png'),
      alt: 'Try Dive + Drift Trike Ticket Banner - Bermuda',
    },
    heading: 'Try Dive + Drift Trike Ticket',
    breadcrumb: {
      lv1T: 'Try Dives / ',
      lv1L: '#',
      lv2T: 'Drift Trike Ticket',
      lv2L: '#',
    },
    description:
      "Experience the Best of Dubai's Underwater World with Bermuda Diving Center's 'Try Scuba Diving' Package + Get Your Adrenaline Pumping with a Complimentary Drift Trike Karting Experience.",
    button: {
      href: '/reservation',
      text: 'Book Now',
    },
  ...
  how: {
    heading: 'Try Scuba Diving + Drift Trike Ticket',
    description: [
      <p key={1}>
      ...
      <p key={2}>
        As a bonus, we&apos;ll provide you with a ticket for an exciting drift
        trike karting experience. It&apos;s a unique activity that combines the
        thrill of karting with the excitement of drifting, providing an
        adrenaline-pumping experience. Exclusively offered by Bermuda Diving
        Center.
      </p>,
    ],
    steps: {
      one: {
        ...
        paragraphs: [
          <p key={1}>
            ...
            comprehensive classroom briefing in our luxurious facilities. How to
            use the scuba gear, basic hand signals, and diving safety. We take
            the time to answer any questions or concerns, ensuring you feel
  ...
  about: {
    ...
    description2: [
      <p key={1}>
        ...
        up to 6 - 8 meters (33 - 39 feet) while being accompanied by our
