...
const CustomImageUploader = ({ title, field, setFieldValue }) => {
  ...
  return (
    <div>
      ...
      <div
        ...
        className={`relative flex overflow-hidden items-center justify-center w-full border h-48 ${
          previewUrl ? 'border-gray-200' : 'border-gray-300 border-dashed'
        } rounded-md`}
      >
        {selectedFile && (
          <>
      ...
      <span className="text-xs text-gray-500">
        1280px by 960px Or 4:3 | Max 5 MB
      </span>
