  ...
  return (
    <section className="px-8 py-14">
      ...
      <AnimatedText tag="div" className={`mt-8 ${nunito.className}`}>
        Embark on an unforgettable adventure and experience the magic of scuba
        diving in Dubai with our Try Beach Scuba Diving package. With expert
        guidance, top-notch facilities, and a fun, friendly atmosphere,
        you&apos;ll be experiencing how it feels like to breath underwater. Book
        your dive today!
      </AnimatedText>
    </section>
  );
