...
import HeroSection from '../../../components/ui/landing-pages/try-scuba-diving/Hero';
import Included from '../../../components/ui/landing-pages/try-scuba-diving/Included';
import Why from '../../../components/ui/landing-pages/try-scuba-diving/Why';
import Packages from '../../../components/ui/landing-pages/try-scuba-diving/Packages';
import Testimonials from '../../../components/ui/landing-pages/ui/Testimonials';
import CallToAction from '../../../components/ui/landing-pages/try-scuba-diving/CallToAction';
...
const TryScubaDivingLandingPage = ({ data }) => {
  return (
    <div className="flex justify-center h-full bg-black">
      <div className="max-w-[400px] w-full bg-[#edf5ff]">
        <HeroSection />
        ...
        <CallToAction from="Try Scuba Diving - Landing Page" />
