...
import { content } from '../../../components/ui/pages/dsd/vip';
...
export const getServerSideProps = async () => {
  ...
  try {
    const res = await axios.get('/api/web/cms/courses/5');
...
VipTryDivePage.getLayout = function getLayout(page) {
